    ...
    constructor() {
        ...
        MystaysBookingWidget.prototype.Common = {
            ...
            BookingWidgetContainerElement: function () {
                if (MystaysBookingWidget.prototype.Common.BookingWidgetContainer === '') {
                    return document;
                }
            ...
            MystaysBookingWidget.prototype.Loaded = function Loaded(selectedLanguage, FilterCities, BookingWidgetContainerID) {
                ...
                this.Common.SelectedLanguage = selectedLanguage;

                
                this.Common.BookingWidgetContainer = BookingWidgetContainerID + ' ';
